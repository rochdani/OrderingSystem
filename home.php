										...
										<div class="container" style="font-family:navfont; font-color:White;">
											<img src="Images/logo.png" alt="Dulsara logo">
												<div id="navcontent">
													...
													<a class="navbar-brand" style="color:White;" href="./foodss/view.php">View Foods</a>
													<a class="navbar-brand" style="color:White;" href="reservation.php">View Tables</a>
...
<div class="bodygreatfood">
       ...
       <p class="Greatfood"> 
        ...
        <p class="GreatfoodCont">
                ...
                Write something here about  restaurant. Write something here about  restaurant.Write something here about  restaurant.Write something here about  restaurant.Write something here about  restaurant.Write something here about  restaurant.Write something here about  restaurant. Write something here about  restaurant. Write something here about  restaurant.Write something here about  restaurant.Write something here about  restaurant.Write somerant.Write something here about  restaurant.Write something here about  restaurant. 
        ...
        <p class="Reservetable">
                ...
                <button type="button" class="mybutton">MAKE A RESERVATION</button>
        </p> 
</div>
...
<div class="dulasarastory">
       ...
       <p class="dulasarastoryhead"> 
        ...
        <p class="dulasarastorycont">
                ...
                This is one of retaurant shows the diversity in means of unique experiences in each of the retaurant with all facilities. restaurant.Write something here about  restaurant.Write something here about  restaurant.Write something here about  restaurant.Write something here about  restaurant.Write something here about  restaurant. Write something here about  restaurant. Write something here about  restaurant.Write something here about  restaurant.Write something here about  restaurant.Write somerant.Write something here about  restaurant.Write something here about  restaurant. 
        ...
        <p class="Aboutus">
                ...
                <button type="button" class="mybutton">ABOUT US</button>
        </p> 
</div>
