		  ...
		  <!-- Navbar content -->
			...
			<div class="w3-card-4 w3-col s12 w3-margin">
				<div class="w3-container w3-padding ">
					<div class="row  w3-xxxlarge " style="padding-left:16px"><img src="imgs/OnlineFoodOrdering.png" style="width:10%; height:10%">&nbsp;&nbsp;</i> Orders </div>
				</div>
				<div class="w3-container w3">
					<!--searching bar-->

					<div class="row  w3-margin" >
						<button  class="w3-btn w3-block w3-green  col-md-3" type="button"><i class="fa fa-plus"></i>&nbsp;View Orders</button>
					</div>	
