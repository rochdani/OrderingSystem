...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2018 at 08:54 AM
...
INSERT INTO `customer` (`cus_id`, `cus_fname`, `cus_lname`, `username`, `password`, `nic`, `country`, `mobile`, `email`) VALUES
(5, 'archchana', 'sivarajah', 'archchu', 'badulla18', '956771544v', 'SriLanka', 756767882, 'archchu95@gmail.com'),
(7, 'roch', 'danistan', 'roch', 'badulla23', '954546672v', 'srilanka', 756456777, 'roch23@gmail.com'),
(6, 'shiyani', 'kirupa', 'shiyani', 'colombo12', '956784948v', 'australia', 756788778, 'shiyani56@gmail.com'),
(8, 'theepak', 'ghhgjh', 'bjhv', 'badulla12', '436457447v', 'gfhgj', 56748, 'vgc'),
(9, 'theepak', 'ghhgjh', 'bjhv', 'as', '436457447v', 'gfhgj', 56748, 'vgc'),
(10, 'dnjfk', 'sjdbks', 'archchu', 'badulla12', '3728673v', 'smdcnsl', 276378153, ',nmvlsvn');
...
(111, 'ojksdkn', 'kadnkasdnk ', '', 0, ''),
(212, 'bkbdk', ' efwef', '', 0, ''),
(464, 'fvfv', ' ', '10', 0, ''),
(355, 'nsdk', ' wdnasldnasld', '', 0, ''),
(789, 'theepag', 'sdcnadlnkdf ', '2', 456, ''),
(588, 'Nirupan', 'briyani', '1', 8000, '');
...
--
-- Table structure for table `primary_staff`
--

CREATE TABLE `primary_staff` (
  `pri_staff_id` int(100) NOT NULL,
...
ALTER TABLE `orders`
  ...
  ADD KEY `admin_id` (`admin_id`),
  ADD KEY `customer_id` (`customer_id`),
  ADD KEY `del_staff_id` (`del_staff_id`);

--
-- Indexes for table `primary_staff`
--
ALTER TABLE `primary_staff`
  ADD PRIMARY KEY (`pri_staff_id`);
...
--
ALTER TABLE `foods`
  MODIFY `food_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=790;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `order_no` int(100) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `primary_staff`
--
ALTER TABLE `primary_staff`
  MODIFY `pri_staff_id` int(100) NOT NULL AUTO_INCREMENT;
