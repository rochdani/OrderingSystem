...
<div class="w3-card-4 w3-col s12 w3-margin">
							<div class="w3-container w3-padding ">
								<div class="row  w3-xxxlarge " style="padding-left:16px"><img src="meals.jpg" style="width:40%" "height:10%">&nbsp;&nbsp;</i> Meals </div>
							</div>
							<div class="w3-container w3">
									<!--searching bar-->	
								
									<div class="row  w3-margin" >
										<button  class="w3-btn w3-block w3-green  col-md-3" type="button" onClick= "window.location.href = 'addnew_meal.php';" ><i class="fa fa-plus"></i>&nbsp;Add New Meal</button>
									</div>
									...
									<div class="row  w3-margin "style="margin-top:0px">
										...
										<div class="w3-col s2 "style="margin-left:22px">
											<input class="w3-input w3-border " name="meal_type" type="text" placeholder="meal type_id" id="meal_type">
										</div>
										<div class="w3-col s1 "style="margin-left:22px">
                      ...
                      <?php 
                        ...
                        if ($row =mysqli_fetch_assoc($result)) {
                          ...
                          echo "<td>"; echo "<img src=".$row['gallery_link'].">"; echo "</td>";
