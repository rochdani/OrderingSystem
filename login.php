	...
	<html lang="en">
		...
		<body>
			...
			<div class="row">
				<div class="col-4">
					<center>
						<form  style ="width:400px; height:500px";  action= "./includes/five.php" method="POST">
							...
							<label for="category">Category&nbsp&nbsp&nbsp </label> 
								<select name="category" style="width:172px">
									  ...
									  <option value="primary_staff">primary_staff</option>
									  <option value="admin"> admin</option>
									  <option value="delivery_staff">delivery_staff</option>
									  <option value="lab">table_reservation_staff</option> 
								</select>
