  ...
  <!-- Navbar content -->
   <div class="container" style="font-family:navfont; font-color:White;">
        ...
        <div id="navcontent">
            ...
            <a class="navbar-brand" style="color:White;" href="#">Order Now</a>
            <a class="navbar-brand" style="color:White;" href="#">Reserve Table</a>
            <a class="navbar-brand" style="color:White;"href=""> About Dulsara</a>
            <a class="navbar-brand" style="color:White;"href=home.html>Contact Us</a>
             <a class="navbar-login" href="login.php">Logout </a>
...
<div class="section-page-content row">
                ...
                <div class="adminheader" style="float:right;font-size:16px; ">

                    <a href="#" > Add Meals </a> &emsp;&emsp;&emsp;
                    <a href="#" > Edit Meals </a>&emsp;&emsp;&emsp;
                    <a href="#" > Add Meals </a>&emsp;&emsp;&emsp;
                     <a href="#" > Add Meals </a>&emsp;&emsp;
						...
						<div class="w3-container w3-col s7">
							<form   id="add_meal" method="POST" action="includes/addnewitem.inc.php" enctype="multipart/form-data">
								...
								<div class="w3-padding">
									<textarea class="w3-select w3-border" placeholder="Meal Description" name="meal_desc" type="text" id="meal_desc" rows="6" cols="40"  > </textarea></div>
								<div class="w3-padding">
									<select class="w3-select w3-border" name="eType" data-validation="required" data-validation-error-msg="Please Select a Category" id="eType">
                                        ...
                                        <option name="Chicken" value='1'>Chicken</option>
                                        <option name="Fried Rice" value='2'>Fried Rice</option>
                                        <option name="Koththu" value='3'>Koththu</option>
                                        <option name="Buriyani" value='2'>Buriyani</option>
                                        <option name="Nasigurang" value='2'>Nasigurang</option>
                                      </select>
                                    </div>
								<div class="w3-padding">
